...
public class HyperHeuristic {
	...
	public static double[] weightClimb(List<List<Resource>> resourceGroups, List<List<User>> userGroups,
			double initialStep, double accuracy, double falloff, int depth) {
	...
	private static double getAverageScore(double[] weights, List<List<Resource>> resourceGroups,
			List<List<User>> userGroups, int depth) {
