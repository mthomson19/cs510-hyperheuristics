...
public class User {
	...
	public User(double start, double stop, double size, int p, String n, List<String> validResourceNames,
		...
		// for each available resource, if the name of the resources is in valid
		// resourcenames, add to validResources
